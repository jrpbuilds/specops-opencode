...
Provide 2–4 materially distinct options and one trade-off for each. When you include a Recommendation, put the recommended option first in `Options`; otherwise keep ordering neutral. Do not ask the orchestrator to generate, merge, remove, or rank options. Do not guess and continue.
